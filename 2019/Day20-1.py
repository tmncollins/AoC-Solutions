...
class maze:
    ...
    def __init__(self, maze):
        ...
        print(self.portalNames)
        print(self.portalMap)

        print(self.findShortestPath())

    def findShortestPath(self):
        pending = [(self.start, 0)]
        ...
        while len(pending) > 0:
            ...
            seen.add(look)
            if look == self.end: return dist

            # Look around
            for d in all_dir:
                new = (look[0] + d[0], look[1] + d[1])
                if new in self.empty and new not in seen:
                    pending.append((new, dist + 1))
